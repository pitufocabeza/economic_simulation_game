ALL_GOODS = [
    ...
    # Finished Goods (Placeholder for Later Testing)
    {"name": "Freighter", "primary_category": "finished", "subcategory": "ship", "rarity": "rare"},
    {"name": "Control Unit", "primary_category": "finished", "subcategory": "electronics", "rarity": "rare"},
